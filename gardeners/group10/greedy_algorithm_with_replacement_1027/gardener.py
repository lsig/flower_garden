...
class GreedyGardener(Gardener):
    ...
    def cultivate_garden(self) -> None:
        ...
        while self.remaining_varieties:
            ...
            if self.config['debug']['verbose']:
                ...
                print(f"Iter {iteration}: {len(self.garden.plants)} placed, {len(self.remaining_varieties)} remain{constraint_str}")
    ...
    def _prioritize_varieties(self) -> List[PlantVariety]:
        ...
        if len(self.garden.plants) == 1:
            ...
            available_varieties = [
                v for v in self.remaining_varieties 
                if v.species not in existing_species
            ]
