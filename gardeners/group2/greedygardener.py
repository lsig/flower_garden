...
class Greedy(Gardener):
    ...
    def __init__(self, garden: Garden, varieties: list[PlantVariety]):
        ...
        self.min_available_radius = min([v.radius for v in varieties], default=1.0) if varieties else 1.0
    ...
    def _get_underrepresented_species(self) -> Set[str]:
        ...
        return {
            s for s, count in species_counts.items() if count == min_count
        }
        ...
        while plantable_varieties:
            ...
            if best_placement:
                ...
                if plant is not None:
                    for i, (score, variety) in enumerate(plantable_varieties):
